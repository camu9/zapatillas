...
<br><center>
	...
	<form id="newsForm" action="registroUsuario.php" method="POST">
...
<br>
   ...
   <a href="usuarios_registro.php"> <input type="submit" name="myButton" value="Registrar" required onclick="myButton()" ></a>
